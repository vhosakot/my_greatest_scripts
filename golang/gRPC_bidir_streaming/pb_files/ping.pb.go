...
const file_ping_proto_rawDesc = "" +
	...
	"\vPingService\x121\n" +
	"\x04Chat\x12\x11.ping.PingRequest\x1a\x12.ping.PingResponse(\x010\x01B\fZ\n" +
	"./pb_filesb\x06proto3"
...
var file_ping_proto_depIdxs = []int32{
	0, // 0: ping.PingService.Chat:input_type -> ping.PingRequest
	1, // 1: ping.PingService.Chat:output_type -> ping.PingResponse
