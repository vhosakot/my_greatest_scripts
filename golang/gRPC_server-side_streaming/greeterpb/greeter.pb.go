...
const file_greeter_proto_rawDesc = "" +
	...
	"\x03seq\x18\x02 \x01(\x05R\x03seq2R\n" +
	"\aGreeter\x12G\n" +
	"\x0eSayHelloStream\x12\x18.greeter.v1.HelloRequest\x1a\x19.greeter.v1.HelloResponse0\x01B\fZ\n" +
	"greeterpb/b\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: greeter.v1.Greeter.SayHelloStream:input_type -> greeter.v1.HelloRequest
	1, // 1: greeter.v1.Greeter.SayHelloStream:output_type -> greeter.v1.HelloResponse
